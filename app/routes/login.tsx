...
import { createUserSession, login } from "~/support/session.server";
import { createUser, getUserByUsername } from "~/domain/auth/user";
...
export const action: ActionFunction = async ({
  ...
  case "register": {
    const userExists = await getUserByUsername(username, { select: { id: true } });
    if (userExists) {
